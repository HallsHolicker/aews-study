...
variable "var_subnet_public_bastion_host_cidr" {
  default = "192.168.0.0/24"
}

variable "var_subnet_private_1_az" {
  default = "ap-northeast-2a"
}

variable "var_subnet_private_2_az" {
  default = "ap-northeast-2c"
}

variable "var_subnet_public_bastion_host_az" {
  default = "ap-northeast-2a"
}
...
variable "var_subnet_public_1_az" {
  default = "ap-northeast-2a"
}

variable "var_subnet_public_2_az" {
  default = "ap-northeast-2c"
}
